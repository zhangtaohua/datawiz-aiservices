...
var once sync.Once
var TransHandler *Translator

// NewTranslator 单例模式获取
func NewTranslator(initLang string, langPath string) *Translator {
	once.Do(func() {
		TransHandler = &Translator{}
		TransHandler.InitTranslator(initLang, langPath)
	})
