...
func Success(c *gin.Context) {
	JSON(c, gin.H{
		"code":    SUCCESS,
		"success": true,
		"msg":     translator.TransHandler.T("r.success"),
	})
}
...
func Abort404(c *gin.Context, msg ...string) {
	c.AbortWithStatusJSON(http.StatusNotFound, gin.H{
		"code":    ERROR,
		"success": false,
		"msg":     defaultMessage(translator.TransHandler.T("r.nodataErr"), msg...),
	})
}
...
func Abort403(c *gin.Context, msg ...string) {
	c.AbortWithStatusJSON(http.StatusForbidden, gin.H{
		"code":    ERROR,
		"success": false,
		"msg":     defaultMessage(translator.TransHandler.T("r.authErr"), msg...),
	})
}
...
func Abort500(c *gin.Context, msg ...string) {
	c.AbortWithStatusJSON(http.StatusInternalServerError, gin.H{
		"code":    ERROR,
		"success": false,
		"msg":     defaultMessage(translator.TransHandler.T("r.serHardErr"), msg...),
	})
}
...
func BadRequest(c *gin.Context, err error, msg ...string) {
	...
	c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{
		"code":    ERROR,
		"success": false,
		"msg":     defaultMessage(translator.TransHandler.T("r.reqFormatErr"), msg...),
		"error":   err.Error(),
	})
}
...
func Error(c *gin.Context, err error, msg ...string) {
	...
	c.AbortWithStatusJSON(http.StatusUnprocessableEntity, gin.H{
		"code":    ERROR,
		"success": false,
		"msg":     defaultMessage(translator.TransHandler.T("r.reqParseErr"), msg...),
		"error":   err.Error(),
	})
}
...
func ValidationError(c *gin.Context, errors map[string][]string) {
	c.AbortWithStatusJSON(http.StatusUnprocessableEntity, gin.H{
		"code":    ERROR,
		"success": false,
		"msg":     translator.TransHandler.T("r.reqValidErr"),
		"errors":  errors,
	})
}
